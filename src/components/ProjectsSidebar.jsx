...
export default function ProjectsSidebar({onStartAddProject, projects, onSelectProject, selectedProjectId}){
    ...
    <aside className="w-1/3 px-8 py-16 bg-stone-900 text-stone-50 md:w-72 ">
        <h2 className="mb-8 font-bold uppercase md:text-xl text-stone-200 select-none">Your Projects</h2>
        <div>
        ...
        <ul className="mt-8">
            {projects.map((project) =>{
                let cssClasses = "w-full text-left px-2 py-3 rounded-lg my-1  hover:bg-stone-800 z-20" 
